...
class PinnedModalSheet extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _PinnedModalSheet();
  }
}

class _PinnedModalSheet extends State<PinnedModalSheet> with SingleTickerProviderStateMixin<PinnedModalSheet> {
  ...
  void initState() {
    ...
    if (widget.initialExpanded) _controller.forward();
  }
